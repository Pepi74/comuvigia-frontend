...
import HistorialTutorial from './HistorialTutorial';

describe('HistorialTutorial.tsx', () => {
  beforeEach(() => { vi.clearAllMocks(); });

  it('renderiza sin errores', () => {
    render(<HistorialTutorial run={false} onFinish={vi.fn()} />);
  ...
  it('tiene 4 steps', () => {
    render(<HistorialTutorial run={false} onFinish={vi.fn()} />);
    expect(mockJoyride.mock.calls[0][0].steps.length).toBe(4);
  });
